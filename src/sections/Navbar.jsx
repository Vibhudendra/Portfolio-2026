...
import { ScrollTrigger, SplitText, CSSRulePlugin } from "gsap/all";
...
const Navbar = () => {
  ...
  return (
    <>
      <nav ref={navRef} className='fixed z-50 flex flex-col justify-between w-full h-full 
        px-10 uppercase bg-black text-white/60 py-28 gap-y-10 md:w-1/2 md:left-1/2'>
        ...
        <div className="flex flex-col flex-wrap justify-between gap-8 md:flex-row" ref={contactRef}>
          <div className="font-light">
            <p className='tracking-wider text-white/50'>E-mail</p>
            <p className='text-xl tracking-widest lowercase text-pretty'>vibhudendra.s@gmail.com</p>
          </div>
      ...
      >
        ...
        <span ref={botlineRef} className='block w-8 h-0.5 bg-white rounded-full origin-center'></span>
      </div>
    </>
  )
}
