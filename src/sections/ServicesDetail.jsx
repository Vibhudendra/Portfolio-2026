...
const ServicesDetail = () => {
    ...
    return (
        <section className="min-h-screen bg-black" id="Services">
            <AnimatedHeader
                title="Services"
                sub="Less friction, more interaction."
                aboutText={`Designed with purpose, built for clarity.
Interfaces that stay simple and feel natural.`}
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-2 text-2xl sm:gap-4 lg:text-3xl text-white/80">
                                {service.items.map((item, itemIndex) => (
                                    <div className="" key={`item-${itemIndex}-${item}`}>
                                        <h3 className="flex">
